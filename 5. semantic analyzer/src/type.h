...
/* type.h has defined following types : 
BOOLEAN, NODE_NAME, T_KIND, Q_KIND, S_KIND, ID_KIND, A_NODE, A_TYPE, A_ID, LIT_VALUE, A_LITERAL, A_SPECIFIER
*/
